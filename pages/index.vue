<template>
  <div class="overflow-x-hidden">
    ...
    <div class="max-w-[1280px] w-full mx-auto  py-[150px] flex flex-col lg:flex-row gap-8 lg:px-[24px] px-[16px]">
      ...
      <div data-aos="fade-right" class="flex-1 flex flex-col">
        ...
        <div class="bg-[#fff] rounded-lg hover:shadow-lg transition-shadow">
          <div class="border border-gray-200 rounded-xl p-6 text-center">
            ...
            <div class="flex justify-center my-5">
              <button
                  @click="sendImages"
                  class="bg-[#525252] flex items-center cursor-pointer gap-[5px] text-white py-[16px] px-[32px] rounded-2xl"
              >
                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
      ...
      <div data-aos="fade-left" class="flex-1 flex flex-col p-[16px]">
    ...
    <div class="py-16 lg:py-24 bg-gray-50">
      <div class="max-w-[1200px]  mx-auto w-full lg:px-[24px] px-[16px]">
        <div class="text-center mb-16 lg:mb-20 transition-all duration-1000 transform opacity-100 translate-y-0">
          <h1 data-aos="fade-up" class="text-3xl  font-semibold text-black mb-6 text-center">Why ours actually
            works</h1>
          <p
              class="text-[14px]  text-gray-600 max-w-3xl mx-auto text-center leading-relaxed"
          >
            Most 3D generation tools were built by researchers, not people who actually use 3D models. Ours is
            different.
        ...
        <div class="grid md:grid-cols-2 gap-8 lg:gap-12 max-w-5xl mx-auto">
          <div data-aos="fade-right" class="card p-[24px]  hover:shadow-lg transition-shadow">
            <div class="flex items-start gap-4">
              ...
              <div>
                <h3 class="text-[24px]  font-bold text-center text-black mb-3">Models that actually import
                  correctly</h3>
          ...
          <div data-aos="fade-left" class="card p-[24px] hover:shadow-lg transition-shadow">
            <div class="flex items-start gap-4">
              <div
                  class="w-10 h-10 lg:w-12 lg:h-12 bg-black/5 rounded-lg flex items-center justify-center text-black flex-shrink-0 mt-1">
                <svg class="w-5 h-5 lg:w-6 lg:h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
          ...
          <div
              data-aos="fade-right"
              data-aos-delay="400"
              class="card p-[24px] hover:shadow-lg transition-shadow"
          >
            <div class="flex items-start gap-4">
              <div
                  class="w-10 h-10 lg:w-12 lg:h-12 bg-black/5 rounded-lg flex items-center justify-center text-black flex-shrink-0 mt-1">
    ...
    <div class="py-16 lg:py-24 bg-white">
      <div class="max-w-[1200px] w-full  mx-auto lg:px-[24px] px-[16px]">
        <div class="text-center mb-16 lg:mb-20 transition-all duration-100">
          <h2
              data-aos="fade-up"
              class="lg:text-[30px] text-4xl font-semibold text-black mb-6">See the difference
          </h2>
          <p
              class="text-[14px] text-[#525252]"
              data-aos="fade-up"
              data-aos-delay="400"
          >
    ...
    <!--            See actual 2D to 3D conversions created by teams around the world-->
    <!--          </p>-->
    <!--        </div>-->
    ...
    <!--                    <div class="w-6 h-6 bg-gray-900 text-white rounded-full flex items-center justify-center text-sm font-bold">-->
    <!--                      3-->
    <!--                    </div>-->
    <!--                    <h4 class="font-semibold text-[20px] text-gray-900">-->
    <!--                      Interactive 3D Model-->
    <!--                    </h4>-->
    <!--                  </div>-->
    <!--                  <div class="aspect-square lg:aspect-[4/3] bg-gray-100 rounded-lg overflow-hidden">-->
    <!--                    -->
    <!--                  </div>-->
    <!--                </div>-->
    <!--              </div>-->
    ...
    <div class="max-w-[1200px]  mx-auto w-full lg:px-[24px] px-[16px]">
      <div class="bg-white">
        <div class="text-center mb-[30px]  transition-all duration-1000 transform opacity-100 translate-y-0">
          <h3
              data-aos="fade-up"
              class="text-[30px] font-semibold text-black mb-[32px] text-center"
          >
          ...
          <p
              data-aos="fade-up"
              data-aos-delay="400"
              class="text-[14px] text-gray-600 max-w-2xl mx-auto text-center "
          >
      ...
      <div class="flex items-center justify-center">
        <div class="p-8 text-center">
          <h3
              data-aos="fade-up"
              class="text-[24px] font-medium text-black mb-6">Ready to see what your images can become?
          </h3>
          <p
              data-aos="fade-up"
              data-aos-delay="400"
              class="text-[14px] text-gray-600 mb-8 lg:mb-10 max-w-2xl mx-auto text-center leading-relaxed"
          >
    ...
    <div class="py-16  bg-white">
      <div class="max-w-[1200px]  mx-auto w-full lg:px-[24px] px-[16px]">
        <div class="text-center mb-16 lg:mb-20 transition-all duration-1000 transform opacity-100 translate-y-0">
          <h2
              data-aos="fade-up"
              class="text-[30px] font-semibold text-black mb-6 text-center">Questions people actually ask
          </h2>
          <p
              data-aos="fade-up"
              data-aos-delay="400"
              class="text-[14px] text-gray-600 max-w-2xl mx-auto text-center leading-relaxed"
          >
            Straight answers to the things you're probably wondering about.
          </p>
        </div>
...
const uploadedUrls = ref([]); // Массив для хранения ссылок на файлы
...
const handleFileUpload = async (event) => {
  ...
  for (const file of files) {
    ...
    if (!file.type.match('image/(png|jpeg|jpg)')) {
      errorMessage.value += `\nUnsupported format: ${file.name}. Only PNG/JPG are allowed.`;
      continue;
    }
    if (file.size > 4 * 1024 * 1024) {
      errorMessage.value += `\nFile too large: ${file.name} (max 4MB).`;
      continue;
    }

    try {
      // Загружаем файл на S3
      const path = await useUploadToS3(file, 'scene/glb_model', 'scene-glb-model-file');
      if (path) {
        uploadedUrls.value.push(`${config.public.AMAZON_URL}${path}`); // Добавляем ссылку в массив
      }
    } catch (error) {
      errorMessage.value = `Ошибка загрузки файла ${file.name}.`;
      console.error(error);
    }

    // Создаём предпросмотр файла
...
const sendImages = async () => {
  if (!uploadedUrls.value.length) {
    console.error('Нет загруженных изображений для отправки.');
    return;
  }

  try {
    const { data } = await useAuthFetch('/api/ai/genie/image-to-3d', {
      method: 'post',
      headers: {
      ...
      body: JSON.stringify({
        image_urls: uploadedUrls.value, // Отправляем массив ссылок
      }),
    });
